package com.terrypaton.graphics {
	...
	public class DrawPieChart {
		...
		public static function drawChart(_shape:Shape, _radius:Number, _percent:Number, _colour:uint = 0xFF0000, _rotationOffset:Number = 0, _calpha:Number = .5)
		{
			if (_percent > 1) {
				_percent = 1;
			}
			...
			_shape.graphics.beginFill(_colour, _calpha);
...
// segment.y = 100;
// addChild(segment);
// var percent:Number = 0.33;
// DrawPieChart.drawChart(segment, 80, percent, 0x0000FF, -90);