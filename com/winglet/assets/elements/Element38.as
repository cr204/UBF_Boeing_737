package com.winglet.assets.elements {
	...
	public class Element38 extends ThrustLever {
		private var mainTL:*;
...
//				lever.addEventListener(MouseEvent.MOUSE_UP, mouseUpHandler);
		...
		public function defaultPosition(s:String):void {
			if(s=="idle") lever.y=0 else lever.y=68;
		}
		...
		private function mouseMoveHandler(e:MouseEvent):void {
			if((mouseY - locY)<68 && (mouseY - locY) > 0) {
				lever.y = mouseY - locY;
			}
		}
