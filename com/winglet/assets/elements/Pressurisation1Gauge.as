package com.winglet.assets.elements {
	...
	public class Pressurisation1Gauge extends Sprite {
		...
		public function Pressurisation1Gauge() {
			// constructor code
			pointer1.rotationZ = 0; //326;
		}
...
//			trace("startTweening - time:" + time + "  - nextPosition:" + nextPosition);
		...
		private function rotatePointer(deg:Number):void {
			if(deg>326) {
				pointer1.rotationZ = 326;
			} else if(deg<0) {
				pointer1.rotationZ = 0;
			} else {
				pointer1.rotationZ = deg;
			}
		}
