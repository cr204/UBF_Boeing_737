package com.winglet.assets.elements {
	...
	public class Element11_b extends ElementSpriteBase {
		public var isActiveElement:Boolean = false;
		public var elementSSwitch:String = "none";
		private var initMouseX:Number = 837;
		...
		private function mouseUpHandler(e:MouseEvent):void {
			...
			if(elementSSwitch==leverPos.toString()) this.dispatchEvent(new ElementPressedEvent(leverPos.toString()));
